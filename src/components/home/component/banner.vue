<template>
  <section class="banner">
      <img src="@/assets/img/banner.png" class="img-responsive banner-bg bigshow" alt="">
...
export default {
  ...
  methods: { 
    ...
    //     obj.style.color = obj.value.length ? "#ffffff" : "";
    // }
    getAddressInfo(arg) {
    ...
    EstimateTemplate() {
      ...
      this.loading = true
      // console.table(dataA, '3333333333')
      this.$http.get('/home/sample-product?' + this.$qs.stringify(dataA)).then(res => {
          // console.log(res, 'loacalhost')
